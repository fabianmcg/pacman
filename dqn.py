...
class DQNState:
    ...
    def setOutcome(self, state):
        pass

class DQNAgent(Agent):
    def __init__(self, alpha = 0.25, gamma = 0.75, experienceSize = 400, minibatchSize = 100, C = 10, numTraining = 0, epsilon = 1., learningRate = 0.1, **kwargs):
        self.it = 0
        self.git = 0
        self.index = 0
        self.experienceIt = 0
    ...
    def initNetworks(self, stateShape):
        ...
        self.QNetwork = convolutionalNetwork([(1, 2)], self.architecture, stateShape, tf.keras.optimizers.Adam(learning_rate=self.learningRate), RandomUniform(minval=-0.05, maxval=0.05, seed=None))
